...
HELP_DATA = {
    "mod": (f"{E.NUKE} Moderation", [
        ("/ban <member> [reason]", "Bannt einen Nutzer permanent", "Ban Members",
         "/ban @User Spam"),
        ("/tempban <member> <duration> [reason]", "Bannt temporär", "Ban Members",
        ...
        ("/warnings <member>", "Zeigt Verwarnungs-Historie", "Manage Messages",
         "/warnings @User"),
        ("/clearwarning <member> <index>", "Löscht eine Verwarnung", "Manage Messages",
         "/clearwarning @User 2"),
        ("/clearwarnings <member>", "Löscht alle Verwarnungen", "Manage Messages",
         "/clearwarnings @User"),
        ("/mute <member> [duration] [reason]", "Timeout in Sekunden", "Moderate Members",
         "/mute @User 600 Spam"),
        ("/tempmute <member> <duration> [reason]", "Persistenter Mute", "Moderate Members",
        ...
        ("/nick <member> [nickname]", "Ändert Nickname", "Manage Nicknames",
         "/nick @User Cooler Name"),
    ...
    "owner": (f"{E.OWNER} Owner/Admin", [
        ...
        ("/massunban", "Entbannt alle Nutzer", "Administrator", "/massunban"),
        ("/massrole_remove <role>", "Entfernt Rolle von allen", "Administrator",
         "/massrole_remove @Old"),
    ...
    "appeal": (f"{E.APPEAL} Appeal-System", [
        ("/logban <#channel>", "Kanal für Entbannungsanträge setzen", "Administrator",
         "/logban #appeals"),
        ("!banappeal <user_id> [reason]", "Startet Appeal-Prozess", "Ban Members",
         "!banappeal 123 Spam"),
