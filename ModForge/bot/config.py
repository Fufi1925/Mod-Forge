...
HELP_DATA = {
    ...
    "info": (f"{E.USERS} Info & Stats", [
        ...
        ("/note <member> <text>", "Interne Mod-Notiz", "Manage Messages", "/note @User Beobachten"),
        ("/notes <member>", "Alle Notizen anzeigen", "Manage Messages", "/notes @User"),
        ("/delnote <member> <index>", "Notiz löschen", "Manage Messages", "/delnote @User 1"),
    ...
    "community": (f"{E.USERS} Community", [
        ("/poll <frage> <opt1> <opt2> [opt3] [opt4]", "Abstimmung", "—", "/poll Pizza oder Burger? Pizza Burger"),
    ...
    "modplus": (f"{E.SHIELD} Mod+", [
        ("/raidmode <on/off> [dauer]", "Manueller Raid-Modus", "Administrator", "/raidmode on 30"),
        ("/softban <member> [days] [grund]", "Ban+Unban (löscht Nachrichten)", "Ban Members", "/softban @User"),
        ("/purge_user <member> [amount]", "Nachrichten eines Users löschen", "Manage Messages", "/purge_user @User 50"),
        ("/purge_bots [amount]", "Bot-Nachrichten löschen", "Manage Messages", "/purge_bots 50"),
        ("/purge_links [amount]", "Link-Nachrichten löschen", "Manage Messages", "/purge_links"),
        ("/purge_images [amount]", "Bild-Nachrichten löschen", "Manage Messages", "/purge_images"),
        ("/lockall [grund]", "ALLE Kanäle sperren", "Administrator", "/lockall Raid"),
        ("/unlockall", "Alle Kanäle entsperren", "Administrator", "/unlockall"),
        ("/noprefix [on/off]", "No-Prefix-Modus", "Administrator", "/noprefix true"),
        ("/noprefix_add <member>", "Zur No-Prefix Whitelist", "Administrator", "/noprefix_add @Mod"),
        ("/autobanappeal [on/off]", "Auto Ban-Appeal DMs", "Administrator", "/autobanappeal true"),
    ]),
